...
const en={brand:'Observatory',undo:'Undo',redo:'Redo',trash:'Trash',export:'Export',installApp:'Install app',installing:'Installing…',theme:'Switch theme',saved:'Saved locally',saving:'Saving…',failed:'Save failed',updateReady:'A new version is ready.',updateNow:'Update now'}
const overrides={
